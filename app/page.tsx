...
const locales: Locale[] = [
  ...
  { id: "ph", slug: "philippines", flag: "PH", place: "Philippines", local: "Pilipinas", languages: "Filipino · Philippine English", note: "Parallel English and Filipino broadcast traditions built around retained international species names.", years: "1999—today", coreGame: "No Filipino core-game edition", coreYear: null, animeYear: 1999 },
  { id: "pt", slug: "portugal", flag: "PT", place: "Portugal", local: "Portugal", languages: "European Portuguese", note: "English-language games surrounded by Portuguese packaging, manuals, television dialogue, songs, and titles.", years: "1999—today", coreGame: "No European Portuguese core-game edition", coreYear: null, animeYear: 1999 },
  ...
  { id: "il", slug: "israel", flag: "IL", place: "Israel", local: "ישראל", languages: "Hebrew", note: "English species identities in right-to-left Hebrew script, with a long hiatus and 2016 television return.", years: "2000—today", coreGame: "No Hebrew core-game edition", coreYear: null, animeYear: 2000 },
  { id: "ar", slug: "arab-world", flag: "AR", place: "Arab world", local: "العالم العربي", languages: "Arabic", note: "A pan-regional dub shaped by Syrian and Lebanese studios, English source material, interruption, and revival.", years: "2000—today", coreGame: "No Arabic core-game edition", coreYear: null, animeYear: 2000 },
  { id: "my", slug: "malaysia", flag: "MY", place: "Malaysia", local: "Malaysia", languages: "Malay · English", note: "A multilingual media history whose Malay dub shifted between Japanese and English source editions.", years: "2000—today", coreGame: "No Malay core-game edition", coreYear: null, animeYear: 2000 },
...
const animeLocalizationTimeline = [
  ...
  { year: 1999, entries: [
    ...
    { label: "Philippine English", place: "Philippines", href: "/locales/philippines", detail: "First broadcast · 1 Oct" },
    { label: "European Portuguese", place: "Portugal", href: "/locales/portugal", detail: "First broadcast · 2 Oct" },
  ...
  { year: 2000, entries: [
    ...
    { label: "Hebrew dub", place: "Israel", href: "/locales/israel", detail: "First documented period · early 2000" },
    { label: "Arabic dub", place: "Arab world", href: "/locales/arab-world", detail: "First MBC broadcast · exact day unresolved" },
    { label: "Malay / English", place: "Malaysia", href: "/locales/malaysia", detail: "First broadcast · 25 Nov" },
...
const localeMedia: Record<string, { src: string; alt: string; kind: string }> = {
  ...
  ph: { src: "/exhibits/philippines-portal.png", alt: "Official Pokémon Philippines portal artwork", kind: "Philippine official portal" },
  pt: { src: "/exhibits/portugal-horizons-logo.png", alt: "European Portuguese Pokémon Horizontes logo", kind: "Portugal anime title" },
  ...
  il: { src: "/exhibits/hebrew-pokemon-logo.png", alt: "Official Hebrew Pokémon title logo", kind: "Hebrew title artifact" },
  ar: { src: "/exhibits/arabic-pokemon-logo.png", alt: "Official Arabic Pokémon title logo", kind: "Arabic title artifact" },
  my: { src: "/exhibits/malaysia-portal.png", alt: "Official Pokémon Malaysia portal artwork", kind: "Malaysia official portal" },
