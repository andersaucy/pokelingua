...
const routeFamilies: Array<{ kind: RouteKind; label: string; title: string; text: string; locales: string }> = [
  ...
  { kind: "english", label: "International / English reference", title: "One shared species vocabulary", text: "The English or international spelling is retained, pronounced locally, or represented in another script while the surrounding dialogue is translated.", locales: "Italy · Spain · Latin America · Brazil · Portugal · Philippines · Malaysia · Indonesia · Arabic · Hebrew · Russia · Türkiye · current India · current Vietnam" },
...
const localeRoutes: Array<{ locale: string; local: string; href: string; kind: RouteKind; route: string; note: string; history?: string }> = [
  ...
  { locale: "Indonesia", local: "Indonesia", href: "/locales/indonesia", kind: "english", route: "International names retained", note: "Indonesian-language animation and services generally retain the English proper-name layer." },
  { locale: "Portugal", local: "Portugal", href: "/locales/portugal", kind: "english", route: "International names retained", note: "European Portuguese localizes dialogue, songs, titles, packaging, and manuals around the shared species vocabulary." },
  { locale: "Philippines", local: "Pilipinas", href: "/locales/philippines", kind: "english", route: "International names retained", note: "English and Filipino broadcasts generally share the international species layer and characteristic cries." },
  { locale: "Malaysia", local: "Malaysia", href: "/locales/malaysia", kind: "english", route: "International names retained", note: "Malay presentation retains the species layer even when its source edition changes between Japanese and English." },
  { locale: "Arab world", local: "العالم العربي", href: "/locales/arab-world", kind: "english", route: "English → Arabic script", note: "Anime records generally write English-derived identities in Arabic, with a few freer early-dub choices." },
  { locale: "Israel", local: "ישראל", href: "/locales/israel", kind: "english", route: "English → Hebrew script", note: "The dub represents retained species identities right-to-left in Hebrew orthography." },
