...
const routeFamilies: Array<{ kind: RouteKind; label: string; title: string; text: string; locales: string }> = [
  ...
  { kind: "english", label: "International / English reference", title: "One shared species vocabulary", text: "The English or international spelling is retained, pronounced locally, or represented in another script while the surrounding dialogue is translated.", locales: "Italy · Spain · Latin America · Brazil · Indonesia · Russia · Türkiye · current India · current Vietnam" },
